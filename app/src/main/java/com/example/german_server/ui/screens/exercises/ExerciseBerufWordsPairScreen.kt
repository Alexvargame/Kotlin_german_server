...
import com.example.german_server.data.ui.viewModel.exercises.ColumnTypeInBeruf
import com.example.german_server.data.ui.components.UserStatsBlock


@Composable
fun ExerciseBerufWordsPairScreen(
    navController: NavController,
    userProfileViewModel: UserViewModel,
    viewModel: ExercisesBerufWordsPairViewModel,

    ) {
    Log.e("WORD_BERUF_PAIR_", "Screen")
    LaunchedEffect(Unit) {
                ...
                rightButtons.forEach { btn ->
                    Button(
                        onClick = {
                            viewModel.onButtonClick(
                                wordId = btn.wordId,
                                column = ColumnTypeInBeruf.RIGHT
                            )
                        },
                        modifier = Modifier.fillMaxWidth(),
                        colors = ButtonDefaults.buttonColors(
