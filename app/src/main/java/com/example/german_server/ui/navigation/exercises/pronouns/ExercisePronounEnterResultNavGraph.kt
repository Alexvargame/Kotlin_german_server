...
import com.example.german_server.ui.screens.exercises.pronouns.ExercisePronounEnterResultScreen
...
fun NavGraphBuilder.exercisesPronounEnterResultNavGraph(
    navController: NavHostController,
    userProfileViewModel: UserViewModel,
    )
{   Log.e("Pronoun_enter", "NavigationREsult")
    composable(
        "exercise_pronoun_enter_result_screen/{correctCount}/{totalQuestions}",
        arguments = listOf(
        ...
        val parentEntry = remember(backStackEntry) {
            navController.getBackStackEntry("exercise_pronoun_enter_screen")
        }
        val exercisesViewModel: ExercisesPronounEnterViewModel = viewModel(parentEntry)
        ExercisePronounEnterResultScreen(
