...
import com.example.german_server.data.ui.components.formatMessageDate

@Composable
fun Support_chat_message_screen(
            ...
            LazyColumn(
                ...
                items(messages,key = { it.server_id ?: it.id }){ msg ->
                    ...
                    SupportMessageCard(
                        ...
                        onClose = { openedMessageId = null } // <- сброс
...
fun SupportMessageCard(
    ...
    val serverAvatar = receiver?.avatarSmallUrl
    Card(
        modifier = Modifier
            .fillMaxWidth(),
        colors = CardDefaults.cardColors(
            containerColor = Color.DarkGray, // светло-серый фон, можно заменить на любой
        ...
        Column(
            ...
            Row(
                ...
                Log.d("SupportMessageAvatar", " ававиап  $receiver?.avatarName")
                val avatarPainter = when {
                    ...
                    !receiver?.avatarName.isNullOrBlank() && AvatarRepository.drawableAvatars.contains(receiver?.avatarName) -> {
                        Log.d("RatingScreen", "PATH ${receiver?.avatarName}")
                        painterResource(
                            id = LocalContext.current.resources.getIdentifier(
                                receiver?.avatarName, "drawable", LocalContext.current.packageName
                            )
                        )
                    }
...
//                        modifier = Modifier.fillMaxWidth(),
//                        placeholder = { Text("Введите ответ...", color = Color.Black) },
//                        singleLine = false,
//                        maxLines = 3,
//                        )
                    TextField(
