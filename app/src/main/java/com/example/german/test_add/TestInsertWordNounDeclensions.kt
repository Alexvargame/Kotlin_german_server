...
class TestInsertWordNounDeclensions(private val context: Context) {

    fun testInsertNounDecl() {
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val nounDeclensionsFormDaoDao = db.nounDeclensionsFormDao()
            Log.d("Noun Decl", "Inserted Word id ")



            nounDeclensionsFormDaoDao.getAll().forEach {
                Log.d("NOUN_DECLS", "Noun row: $it")
            }
